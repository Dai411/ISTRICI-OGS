        ...
        open(12,file='corr')
        read(12,*) ncdp,depth
        print*, 'correggo il cdp ',ncdp, ' a z pari a ',depth
        close(12)
...
c        if(ztop.gt.depth.or.zbot.lt.depth) then
        if((ztop-depth).gt.50..or.(depth-zbot).gt.50.) then
         print*,  'attenzione al picking!',ztop,zbot,depth 
         print*, 'lo accetti (1)?'
         read*, nopt
         if(nopt.ne.1) stop
        endif
...
c  xlambda
 ...
 98     print*, 'attenzione! non ho trovato il punto in x!'
